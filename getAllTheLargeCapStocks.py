...
def checkForCoffeeCanInvestingStocks(dictLargeCap, roceThreshold=15, salesThreshold=10):
    coffeeCanPortfolio = []
...
[dictLargeCap, dictMidCap, dictSmallCap] =  getAllCapStocks(True)
   
ccp = checkForCoffeeCanInvestingStocks(dictLargeCap, 15, 1)
